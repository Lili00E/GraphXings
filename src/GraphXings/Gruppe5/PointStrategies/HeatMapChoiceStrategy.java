...
public class HeatMapChoiceStrategy implements PointChoiceStrategy {
  ...
  private Coordinate getRandomUnusedCoord(Random r, int[][] usedCoordinates, int width, int height,
    ...
    do {
      ...
      // System.out.println("x: " + x + " y: " + y + " stepWidth: " + stepWidth + "
      // stepHeight: " + stepHeight + " width: "
      // + width + " height: " + height + " cx:" + c.getX() + " cy: " + c.getY() +
      // "hw: " + heatMap.getWidth()
      // + " hh: " + heatMap.getHeight()
      // + " placedVertices.size(): " + placedVertices.size());
