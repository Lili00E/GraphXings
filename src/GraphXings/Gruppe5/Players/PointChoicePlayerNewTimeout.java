...
public class PointChoicePlayerNewTimeout implements NewPlayer {
  ...
  public PointChoicePlayerNewTimeout(String name, PointChoiceStrategy minStrategy, PointChoiceStrategy maxStrategy,
