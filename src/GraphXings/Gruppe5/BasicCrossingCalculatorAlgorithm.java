...
public class BasicCrossingCalculatorAlgorithm implements CrossingCalculatorAlgorithm {
    ...
    public static Point reportIntersection(Segment s1, Segment s2) {
        double x1 = GraphXings.Algorithms.RationalComputer.getValue(s1.getStartX());
        double y1 = GraphXings.Algorithms.RationalComputer.getValue(s1.getStartY());
        double x2 = GraphXings.Algorithms.RationalComputer.getValue(s1.getEndX());
        double y2 = GraphXings.Algorithms.RationalComputer.getValue(s1.getEndY());
        double x3 = GraphXings.Algorithms.RationalComputer.getValue(s2.getStartX());
        double y3 = GraphXings.Algorithms.RationalComputer.getValue(s2.getStartY());
        double x4 = GraphXings.Algorithms.RationalComputer.getValue(s2.getEndX());
