...
public class GraphXings {
        public static void main(String[] args) throws FileNotFoundException {
                ...
                // players.add(new PointChoicePlayerOldTimeout("RC 100", new
                // RandomPointChoiceStrategy(100),
                // new RandomPointChoiceStrategy(100),
                // 2000));
                // players.add(new RecursiveSearchPlayer("My Player: Recursive Search", 5, 100,
                // 100, 20000));
                // players.add(new PointChoicePlayerOldTimeout("My Player", new
                ...
                // players.add(new PointChoicePlayerOldTimeout("My Player: Old Timeout", new
                // HeatMapChoiceStrategy(smallHeatMapMin),
                ...
                // }
                //
                // var myPlayer = new PointChoicePlayerOldTimeout("My Player", new
